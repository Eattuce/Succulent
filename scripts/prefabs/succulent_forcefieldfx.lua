...
local function fn()
    ...
    inst.AnimState:SetAddColour(54/255, 250/255, 115/255, 1)
    ...
    inst.Light:SetColour(189/255,200/255,74/255)
    inst.Light:Enable(true)
    inst.Light:EnableClientModulation(true)

    inst._lightframe = net_tinybyte(inst.GUID, "green_forcefieldfx._lightframe", "lightdirty")
    inst._islighton = net_bool(inst.GUID, "green_forcefieldfx._islighton", "lightdirty")
    inst._lighttask = nil
...
return Prefab("green_forcefieldfx", fn, assets)
